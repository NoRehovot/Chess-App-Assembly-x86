...
IsCheckW db 0 ; represents whether there is a check for the white king (0 for no, 1 for yes)
IsCheckB db 0 ; represents whether there is a check for the black king (0 for no, 1 for yes)
KingMoved1 db 0 ; represents whether player1's king moved in this game (0 for no, 1 for yes)
RookMoved1 db 0 ; represents whether player1's rook moved in this game (0 for no, 1 for yes)
KingMoved2 db 0 ; represents whether player2's king moved in this game (0 for no, 1 for yes)
RookMoved2 db 0 ; represents whether player2's rook moved in this game (0 for no, 1 for yes)
squareClickedOn db 64 ; represents the array index the player "clicked" on. 64 represents no click on the board
